...
namespace BusinessLogic
{
    ...
    public class ReprovacaoTurmaBL : SPERepository<ReprovacaoTurma>
    {
        public ReprovacaoTurmaBL(TransactionRepository transaction)
            : base(transaction)
        {
        ...
        public void AtualizarTurma(ReprovacaoTurma reprovacaoTurma)
        {
            //var existe = this.Get(e => string.Compare(e.Nome.ToLower(), areaAtuacao.Nome.ToLower(), CultureInfo.CurrentCulture, CompareOptions.IgnoreNonSpace) == 0

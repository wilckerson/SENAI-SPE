...
namespace Common.Extensions.DateEx
{
    public static class DateExtension
    {
        ...
        public static Dictionary<int,string> GetAllMonths()
        {
            Dictionary<int,string> listMonths = new Dictionary<int,string>();
            
            for (int i = 1; i <= 12; i++)
            {
                listMonths.Add(i, DateTimeFormatInfo.CurrentInfo.GetMonthName(i).UppercaseFirst());
            }
        ...
        {
            return GetRelativeDateValue(date, DateTime.Now.AddHours(-3));
        }

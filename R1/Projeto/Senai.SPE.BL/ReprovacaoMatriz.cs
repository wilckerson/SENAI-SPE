...
namespace BusinessLogic
{
    ...
    public class ReprovacaoMatrizBL : SPERepository<ReprovacaoMatriz>
    {
        public ReprovacaoMatrizBL(TransactionRepository transaction)
            : base(transaction)
        {
        ...
        public void AtualizarMatriz(ReprovacaoMatriz reprovacaoMatriz)
        {
            //var existe = this.Get(e => string.Compare(e.Nome.ToLower(), areaAtuacao.Nome.ToLower(), CultureInfo.CurrentCulture, CompareOptions.IgnoreNonSpace) == 0
            ...
            this.Update(reprovacaoMatriz);
        }

        //public void DeletarAreaAtuacao(int id)
        //{
        //    AreaAtuacao areaAtuacao = this.Get(e => e.IdAreaAtuacao == id, null, "Matriz,Usuario").SingleOrDefault();

        //    if (areaAtuacao.Matriz.Any() || areaAtuacao.Usuario.Any())
